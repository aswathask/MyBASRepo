		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsampleodatasample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsampleodatasample-display": {
								"semanticObject": "comsampleodatasample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.odatasample",
									"url": sap.ui.require.toUrl("com/sample/odatasample")
								}
							}
						}
					}
